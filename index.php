  ...
  <body class="bg-gradient-to-l from-[#8DBCC7] to-[#A4CCD9]">
    ...
    <main class="min-h-screen flex justify-between items-center px-40">
      <div class="max-w-2xl">
        ...
        <h6 class="text-xl font-semibold text-slate-800">Jodi Jonatan | 2025</h6>
        <p>Website ini hanya dibuat untuk belajar backend development saja, dibuat dengan PHP, TailwindCSS, html dan MySQL. Website ini dibuat untuk belajar berinteraksi antara frontend dengan backend dan database</p>
      </div>
